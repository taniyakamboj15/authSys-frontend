    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-2xl bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="bg-blue-600 px-6 py-4">
          <h1 className="text-2xl font-bold text-white">{UI_TEXT.PROFILE.TITLE}</h1>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="border-t border-gray-200 pt-6">
            <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-4">{UI_TEXT.PROFILE.ACCOUNT_DETAILS}</h3>
            <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
              <div>
                <dt className="text-sm font-medium text-gray-500">{UI_TEXT.PROFILE.USER_ID_LABEL}</dt>
                <dd className="mt-1 text-sm text-gray-900">{user?._id}</dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">{UI_TEXT.PROFILE.VERIFICATION_LABEL}</dt>
                <dd className="mt-1 text-sm text-gray-900">
                  {{
                    true: <span className="text-green-600">{UI_TEXT.PROFILE.VERIFIED}</span>,
                    false: <span className="text-yellow-600">{UI_TEXT.PROFILE.UNVERIFIED}</span>,
